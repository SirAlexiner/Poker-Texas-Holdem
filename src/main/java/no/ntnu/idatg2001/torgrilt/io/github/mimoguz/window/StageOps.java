package no.ntnu.idatg2001.torgrilt.io.github.mimoguz.window;
...
public class StageOps {
   ...
   */
  public static boolean dwmSetIntValue(final WindowHandle handle, final DwmAttribute attribute,
                                       final int value) {
    if (handle == null) {
      return false;
    }
  ...
  private static boolean isOk(final WinNT.HRESULT result) {
    return IntegerType.compare(result, WinError.S_OK) == 0;
  }
